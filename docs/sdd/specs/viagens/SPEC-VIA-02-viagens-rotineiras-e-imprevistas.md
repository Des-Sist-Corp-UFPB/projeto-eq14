# SPEC-VIA-02 — Viagens Rotineiras e Imprevistas
...
| **Relacionada** | [SPEC-VIA-01](SPEC-VIA-01-gestao-viagens.md) (viagens atuais), [SPEC-CAD-02](../cadastros/SPEC-CAD-02-gestao-veiculos.md), [SPEC-CAD-03](../cadastros/SPEC-CAD-03-gestao-cidades.md) |
...
> foi separada na [SPEC-CAD-04](../cadastros/SPEC-CAD-04-endereco-do-passageiro.md) e será implementada **antes** desta
...
> Migration **V9** (após o **V8** de `enderecos`, SPEC-CAD-04): cria `linhas_programadas` (+
...
## 8. Impacto na SPEC-VIA-01

A SPEC-VIA-01 (criar/listar/excluir viagem) continua válida para **imprevistas** e ganha o eixo
