# SPEC-ACE-02 — Login Social com Google (OAuth2 / OIDC)
...
| **Relacionada** | [SPEC-ACE-01](SPEC-ACE-01-autenticacao.md) (login senha), [SPEC-CAD-01](../cadastros/SPEC-CAD-01-gestao-usuarios.md) (usuários), [SPEC-CAD-04](../cadastros/SPEC-CAD-04-endereco-do-passageiro.md) (perfil do passageiro) |
...
- Enquanto incompleto, um **filtro** (`PerfilIncompletoFilter`) redireciona o usuário para `/conta/completar`
  (informar telefone) antes de acessar funções de negócio. Casa com a SPEC-CAD-04: o passageiro **já**
...
em SPEC-ACE-01 (login) e SPEC-CAD-01 (usuários) e dialoga com a SPEC-CAD-04 (perfil do passageiro: "não navega
