# SPEC-CAD-04 — Perfil e Endereço do Passageiro
...
| **Relacionada** | `perfis_passageiro` (V2), [SPEC-ACE-01](../acesso/SPEC-ACE-01-autenticacao.md), [SPEC-CAD-03](SPEC-CAD-03-gestao-cidades.md) |
...
Esta spec é implementada **antes** da SPEC-VIA-02 (viagens rotineiras): a migration de `enderecos`
