# SPEC-17 — Healthcheck de banco e analytics de uso (Umami)
...
| **Relacionada** | [SPEC-14](SPEC-14-observabilidade-opentelemetry.md) (mesma área; a telemetria diz *como o sistema se comporta*, esta spec diz *se ele está vivo* e *como é usado*), [SPEC-08](SPEC-08-login-social-google.md)/[SPEC-10](SPEC-10-integracao-whatsapp.md) (padrão de **ativação condicional por variável de ambiente**), [SPEC-12](SPEC-12-verificacao-de-contato-e-recuperacao-de-senha.md) (é dela que vêm as URLs com token que o §6.2 protege) |
...
Mesmo padrão de SPEC-08/10/14: `UMAMI_URL` + `UMAMI_WEBSITE_ID` ausentes ⇒ `ConfiguracaoUmami`
...
não carregaria e **não haveria erro visível**. Foi exatamente o que derrubou o boot na SPEC-10.
...
suba com as variáveis preenchidas (um clone, um túnel de teste, a SPEC-15) contaminaria a
...
- Compose da SPEC-15 sem as variáveis do Umami (**DT-29**).
