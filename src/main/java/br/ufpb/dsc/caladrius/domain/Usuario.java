...
public class Usuario {
     ...
     * o usuário é redirecionado a {@code /conta/completar} — SPEC-ACE-02.
     */
    @Column(name = "perfil_incompleto", nullable = false)
    private boolean perfilIncompleto = false;

    /** Momento em que o telefone foi verificado por OTP (SPEC-ACE-03). {@code null} = não verificado. */
    @Column(name = "telefone_verificado_em")
    private Instant telefoneVerificadoEm;

    /** Momento em que o e-mail foi verificado por link (SPEC-ACE-03). {@code null} = não verificado. */
