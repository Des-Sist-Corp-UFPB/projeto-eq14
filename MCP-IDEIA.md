# Ideia de Servidor MCP — EQ14

**Domínio:** Agendamento de transporte municipal de saúde (CALADRIUS)  
**Data:** 2026-07-01
...
## Servidor proposto: `transporte-mcp`

### Tools sugeridas

- `agendar_transporte(paciente, destino, data)` — agenda viagem
- `consultar_viagens(data)` — viagens do dia
- `capacidade_veiculo(veiculoId)` — lugares livres
- `rota_do_dia(veiculoId)` — paradas planejadas

### Resources (somente leitura)

- agenda de viagens como resource

### Exemplos de uso com um LLM

- "Agende transporte para o paciente João até o hospital de referência na terça."
...
@Service
public class TransporteTools {

    private final SeuService seuService;   // injete seus services/repositories

    public TransporteTools(SeuService seuService) { this.seuService = seuService; }

    @Tool(description = "agenda viagem")
    public Object agendar_transporte(/* params */) {
